...
public class OccurrenceTypeComparator extends ScopedTopicTypeComparator {

	public boolean equals(OccurrenceType o1, OccurrenceType o2) {
		...
		if (stringCompare(o1.getDataType(), o2.getDataType()) == false)
			return false;
