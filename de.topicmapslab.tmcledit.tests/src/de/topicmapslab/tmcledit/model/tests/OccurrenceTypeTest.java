...
import de.topicmapslab.tmcledit.model.compare.OccurrenceTypeComparator;

import junit.framework.Assert;

public class OccurrenceTypeTest extends ScopedTopicTypeTest {

	private OccurrenceType testObject1;
	private OccurrenceType testObject2;
	private OccurrenceTypeComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createOccurrenceType();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createOccurrenceType();

		comp = new OccurrenceTypeComparator();
	}
	...
	/**
	 * Test compares objects with different and equal dataTypes.
	 */
	...
	public void dataTypeTest(){
		...
		testObject1.setDataType("TMCL");
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		testObject2.setDataType("TMQL");
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		testObject2.setDataType("TMCL");
		Assert.assertTrue(comp.equals(testObject1, testObject2));
