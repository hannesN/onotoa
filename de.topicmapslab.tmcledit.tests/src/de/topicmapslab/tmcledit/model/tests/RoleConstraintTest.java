...
public class RoleConstraintTest {

	private RoleConstraint testObject1;
	private RoleConstraint testObject2;
	private RoleConstraintComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createRoleConstraint();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createRoleConstraint();

		comp = new RoleConstraintComparator();
	}
