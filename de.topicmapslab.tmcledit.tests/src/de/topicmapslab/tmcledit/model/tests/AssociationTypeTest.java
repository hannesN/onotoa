...
import de.topicmapslab.tmcledit.model.compare.AssociationTypeComparator;

import junit.framework.Assert;

public class AssociationTypeTest {

	private AssociationType testObject1;
	private AssociationType testObject2;
	private AssociationTypeComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createAssociationType();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createAssociationType();

		comp = new AssociationTypeComparator();
	}
...
//		Assert.assertFalse(comp.equals(testObject1, testObject2));
	...
	/**
	 * Test compares objects with different and equal occurrenceConstraints.
	 */
	...
	/**
	 * Test compares objects with different and equal nameConstraints.
	 */
	...
	/**
	 * Test compares objects with different and equal
	...
	/**
	 * Test compares objects with different and equal subjectLocatorConstraints.
	 */
	...
	/**
	 * Test compares objects with different and equal topicReifierConstraints.
	 */
	...
	@Test
	public void roleCombinationConstraintTest() {

		testObject1.setId(testObject2.getId());

		RoleCombinationConstraint rCombinationConstraint1 = ModelFactory.eINSTANCE
				.createRoleCombinationConstraint();
		RoleCombinationConstraint rCombinationConstraint2 = ModelFactory.eINSTANCE
				.createRoleCombinationConstraint();
		RoleCombinationConstraint rCombinationConstraint3 = ModelFactory.eINSTANCE
				.createRoleCombinationConstraint();
		RoleCombinationConstraint rCombinationConstraint4 = ModelFactory.eINSTANCE
				.createRoleCombinationConstraint();

		// add the same roleCombinationConstraint which is not possible
		testObject1.getRoleCombinations().add(rCombinationConstraint1);
		testObject2.getRoleCombinations().add(rCombinationConstraint1);
		Assert.assertFalse(comp.equals(testObject1, testObject2));

		// add an equal roleCombinationConstraint
		rCombinationConstraint2.setId(rCombinationConstraint1.getId());
		testObject1.getRoleCombinations().add(rCombinationConstraint2);
		Assert.assertTrue(comp.equals(testObject1, testObject2));

		// test different list lengths and different entries
		testObject1.getRoleCombinations().add(rCombinationConstraint3);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		testObject2.getRoleCombinations().add(rCombinationConstraint4);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		...
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		rCombinationConstraint4.setComment("TMQL");
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		rCombinationConstraint4.setComment("TMCL");
		Assert.assertTrue(comp.equals(testObject1, testObject2));
	...
	/**
	 * Test compares objects with different and equal roleConstraints
	 */
	...
	public void rolesTest() {
		...
		RoleConstraint rConstraint1 = ModelFactory.eINSTANCE
				.createRoleConstraint();
		RoleConstraint rConstraint2 = ModelFactory.eINSTANCE
				.createRoleConstraint();
		RoleConstraint rConstraint3 = ModelFactory.eINSTANCE
				.createRoleConstraint();
		RoleConstraint rConstraint4 = ModelFactory.eINSTANCE
				.createRoleConstraint();

		// add the same role which is not possible
		testObject1.getRoles().add(rConstraint1);
		testObject2.getRoles().add(rConstraint1);
		Assert.assertFalse(comp.equals(testObject1, testObject2));

		// add an equal role
		rConstraint2.setId(rConstraint1.getId());
		testObject1.getRoles().add(rConstraint2);
		Assert.assertTrue(comp.equals(testObject1, testObject2));

		// test different list lengths and different entries
		testObject1.getRoles().add(rConstraint3);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		testObject2.getRoles().add(rConstraint4);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		...
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		rConstraint4.setComment("TMQL");
		Assert.assertFalse(comp.equals(testObject1, testObject2));
		rConstraint4.setComment("TMCL");
		Assert.assertTrue(comp.equals(testObject1, testObject2));
	...
	public void scopeTest() {
		...
		ScopeConstraint scope1 = ModelFactory.eINSTANCE.createScopeConstraint();
		ScopeConstraint scope2 = ModelFactory.eINSTANCE.createScopeConstraint();
		ScopeConstraint scope3 = ModelFactory.eINSTANCE.createScopeConstraint();
		ScopeConstraint scope4 = ModelFactory.eINSTANCE.createScopeConstraint();

		// add the same scope which is not possible
		...
		// test different list lengths and different entries
		testObject1.getScope().add(scope3);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
