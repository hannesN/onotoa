...
import de.topicmapslab.tmcledit.model.compare.RoleTypeComparator;

import junit.framework.Assert;

public class RoleTypeTest extends TopicTypeTest {

	private RoleType testObject1;
	private RoleType testObject2;
	private RoleTypeComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createRoleType();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createRoleType();

		comp = new RoleTypeComparator();
	}
