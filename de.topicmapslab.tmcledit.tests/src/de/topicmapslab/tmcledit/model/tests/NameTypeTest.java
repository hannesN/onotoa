...
import de.topicmapslab.tmcledit.model.compare.NameTypeComparator;

import junit.framework.Assert;

public class NameTypeTest extends ScopedTopicTypeTest {

	private NameType testObject1;
	private NameType testObject2;
	private NameTypeComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createNameType();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createNameType();

		comp = new NameTypeComparator();
	}
