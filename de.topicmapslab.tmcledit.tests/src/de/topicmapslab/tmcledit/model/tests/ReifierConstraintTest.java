...
import de.topicmapslab.tmcledit.model.compare.ReifierConstraintComparator;

import junit.framework.Assert;

public class ReifierConstraintTest {

	private ReifierConstraint testObject1;
	private ReifierConstraint testObject2;
	private ReifierConstraintComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createReifierConstraint();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createReifierConstraint();

		comp = new ReifierConstraintComparator();
	}
