...
public class SubjectLocatorConstraintTest extends AbstractRegExpConstraintTest {
	...
	private SubjectLocatorConstraint testObject1;
	private SubjectLocatorConstraint testObject2;
	private SubjectLocatorConstraintComparator comp;
	...
	public void prepare() {
		...
		comp = new SubjectLocatorConstraintComparator();
	}
