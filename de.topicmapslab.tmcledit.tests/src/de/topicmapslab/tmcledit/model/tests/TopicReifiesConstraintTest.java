...
public class TopicReifiesConstraintTest {

	private TopicReifiesConstraint testObject1;
	private TopicReifiesConstraint testObject2;
	private TopicReifiesConstraintComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createTopicReifiesConstraint();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createTopicReifiesConstraint();

		comp = new TopicReifiesConstraintComparator();
	}
