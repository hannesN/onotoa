...
public class DomainDiagramTest extends DiagramTest {
	...
	private DomainDiagram testObject2;
	private DomainDiagramComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createDomainDiagram();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createDomainDiagram();

		comp = new DomainDiagramComparator();
	}
