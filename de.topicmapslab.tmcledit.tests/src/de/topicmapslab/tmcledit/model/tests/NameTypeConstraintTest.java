...
public class NameTypeConstraintTest {

	private NameTypeConstraint testObject1;
	private NameTypeConstraint testObject2;
	private NameTypeConstraintComparator comp;

	@Before
	public void prepare() {

		if (testObject1 == null)
			testObject1 = ModelFactory.eINSTANCE.createNameTypeConstraint();
		if (testObject2 == null)
			testObject2 = ModelFactory.eINSTANCE.createNameTypeConstraint();

		comp = new NameTypeConstraintComparator();
	}
