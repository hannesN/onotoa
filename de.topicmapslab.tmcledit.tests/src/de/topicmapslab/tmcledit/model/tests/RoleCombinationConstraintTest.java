...
public class RoleCombinationConstraintTest extends TMCLConstructTest {
	...
	private RoleCombinationConstraint testObject1;
	private RoleCombinationConstraint testObject2;
	...
	/**
	 * Test compares objects with different and equal otherPlayers
	 */
	...
	public void otherPlayerTest() {
		...
		Assert.assertTrue(comp.equals(testObject1, testObject2));
		testObject1.setOtherPlayer(topicType1);
		testObject2.setOtherPlayer(topicType2);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
	...
	/**
	 * Test compares objects with different and equal otherRoles
	 */

	@Test
	public void otherRoleTest() {
		...
		// set different topic types
		Assert.assertTrue(comp.equals(testObject1, testObject2));
		testObject1.setOtherRole(topicType1);
		testObject2.setOtherRole(topicType2);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
	...
	/**
	 * Test compares objects with different and equal players
	 */
	...
	/**
	 * Test compares objects with different and equal roles.
	 */
	...
	public void roleTest() {
		...
		// set different topic types
		Assert.assertTrue(comp.equals(testObject1, testObject2));
		testObject1.setRole(topicType1);
		testObject2.setRole(topicType2);
		Assert.assertFalse(comp.equals(testObject1, testObject2));
