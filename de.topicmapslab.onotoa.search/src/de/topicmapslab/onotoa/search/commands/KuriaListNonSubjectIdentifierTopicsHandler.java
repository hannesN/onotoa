 ...
 * 
 */
public class KuriaListNonSubjectIdentifierTopicsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		NonSubjectIdentifierTopicSearcher searcher = new NonSubjectIdentifierTopicSearcher(
				schema);
		Collections.sort((List<? extends Comparable>) searcher.getContainer()
				.getList());
		...
		try {
			...
			searchView.setContent(searcher.getContainer());
