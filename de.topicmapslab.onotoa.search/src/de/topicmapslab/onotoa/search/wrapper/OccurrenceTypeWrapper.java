...
/**
 * Wrapper class for the name of an OccurrenceType
 * 
 * @author Sebastian Lippert
 */

@TreeNode(image = "./occurrencetype.gif")
public class OccurrenceTypeWrapper extends AbstractTypeWrapper implements IDoubleClickHandler {
	...
	/**
	 * Getter for name of a OccurrenceType
	 * 
	 * @return name
	 */
