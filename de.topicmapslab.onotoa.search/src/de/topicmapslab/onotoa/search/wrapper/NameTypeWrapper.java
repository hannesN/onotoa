...
/**
 * Wrapper class for the name of an NameType
 * 
 * @author Sebastian Lippert
 */

@TreeNode(image = "./nametype.gif")
public class NameTypeWrapper extends AbstractTypeWrapper {
