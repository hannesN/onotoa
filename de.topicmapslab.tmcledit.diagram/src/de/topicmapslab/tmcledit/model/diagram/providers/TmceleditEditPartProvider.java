...
import de.topicmapslab.tmcledit.model.diagram.edit.parts.TmceleditEditPartFactory;
 ...
 * @generated
 */
public class TmceleditEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public TmceleditEditPartProvider() {
		setFactory(new TmceleditEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!TopicMapSchemaEditPart.MODEL_ID
					.equals(TmceleditVisualIDRegistry.getModelID(view))) {
				return false;
			}
