 ...
 * @generated
 */
public class TmcleditViewProvider extends AbstractViewProvider {
	...
	protected Class getDiagramViewClass(IAdaptable semanticAdapter,
		...
		if (TopicMapSchemaEditPart.MODEL_ID.equals(diagramKind)
				&& TmcleditVisualIDRegistry.getDiagramVisualID(semanticElement) != -1) {
	...
	protected Class getNodeViewClass(IAdaptable semanticAdapter,
		...
		if (semanticHint == null) {
			...
			visualID = TmcleditVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = TmcleditVisualIDRegistry.getVisualID(semanticHint);
			if (elementType != null) {
				// Semantic hint is specified together with element type.
				// Both parameters should describe exactly the same diagram element.
				// In addition we check that visualID returned by VisualIDRegistry.getNodeVisualID() for
				// domainElement (if specified) is the same as in element type.
				if (!TmcleditElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != TmcleditVisualIDRegistry
				...
				if (!TopicMapSchemaEditPart.MODEL_ID
						.equals(TmcleditVisualIDRegistry
				...
				case TopicTypeIdentifierCompartmentEditPart.VISUAL_ID:
					if (NameTypeEditPart.VISUAL_ID != TmcleditVisualIDRegistry
				...
				case TopicTypeIdentifierCompartment3EditPart.VISUAL_ID:
					if (ScopeTypeEditPart.VISUAL_ID != TmcleditVisualIDRegistry
							.getVisualID(containerView)
							|| containerView.getElement() != domainElement) {
						return null; // wrong container
					}
				...
				case RoleTypeIdentifierCompartmentEditPart.VISUAL_ID:
					if (RoleTypeEditPart.VISUAL_ID != TmcleditVisualIDRegistry
							.getVisualID(containerView)
							|| containerView.getElement() != domainElement) {
						return null; // wrong container
					}
				...
				case AssociationsTypeIdentifierCompartmentEditPart.VISUAL_ID:
					if (AssociationsTypeEditPart.VISUAL_ID != TmcleditVisualIDRegistry
							.getVisualID(containerView)
							|| containerView.getElement() != domainElement) {
						return null; // wrong container
					}
				...
				case OccurenceTypeIdentifierCompartmentEditPart.VISUAL_ID:
					if (OccurenceTypeEditPart.VISUAL_ID != TmcleditVisualIDRegistry
							.getVisualID(containerView)
							|| containerView.getElement() != domainElement) {
						return null; // wrong container
					}
				...
				case TopicTypeIdentifierCompartment4EditPart.VISUAL_ID:
					if (TopicTypeEditPart.VISUAL_ID != TmcleditVisualIDRegistry
							.getVisualID(containerView)
							|| containerView.getElement() != domainElement) {
						return null; // wrong container
					}
	...
	protected Class getNodeViewClass(View containerView, int visualID) {
		if (containerView == null
				|| !TmcleditVisualIDRegistry.canCreateNode(containerView,
						visualID)) {
			return null;
		}
		switch (visualID) {
	...
	protected Class getEdgeViewClass(IAdaptable semanticAdapter,
		...
		int visualID = TmcleditVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(semanticAdapter);
		if (domainElement != null
				&& visualID != TmcleditVisualIDRegistry
