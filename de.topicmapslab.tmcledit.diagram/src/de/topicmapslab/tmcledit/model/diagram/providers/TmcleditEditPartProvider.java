...
import de.topicmapslab.tmcledit.model.diagram.edit.parts.TmcleditEditPartFactory;
 ...
 * @generated
 */
public class TmcleditEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public TmcleditEditPartProvider() {
		setFactory(new TmcleditEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!TopicMapSchemaEditPart.MODEL_ID
					.equals(TmcleditVisualIDRegistry.getModelID(view))) {
				return false;
			}
