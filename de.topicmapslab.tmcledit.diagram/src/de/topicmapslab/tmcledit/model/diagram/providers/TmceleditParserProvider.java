 ...
 * @generated
 */
public class TmceleditParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	protected IParser createNameTypeId_4001Parser() {
		EAttribute[] features = new EAttribute[] { TMPackage.eINSTANCE
				.getTopicType_Id(), };
	...
	protected IParser createNameTypeConstraint_2001Parser() {
		EAttribute[] features = new EAttribute[] {
				TMPackage.eINSTANCE.getAbstractContraint_Name(),
				TMPackage.eINSTANCE.getAbstractContraint_CardMin(),
				TMPackage.eINSTANCE.getAbstractContraint_CardMax(),
				TMPackage.eINSTANCE.getAbstractContraint_Regexp(), };
		MessageFormatParser parser = new MessageFormatParser(features);
	...
	protected IParser createOccurenceTypeConstraint_2002Parser() {
		EAttribute[] features = new EAttribute[] {
				TMPackage.eINSTANCE.getAbstractContraint_Name(),
				TMPackage.eINSTANCE.getOccurenceTypeConstraint_DataType(),
				TMPackage.eINSTANCE.getAbstractContraint_CardMin(),
				TMPackage.eINSTANCE.getAbstractContraint_CardMax(), };
		MessageFormatParser parser = new MessageFormatParser(features);
		parser.setViewPattern("{0} : {1} \t {2}..{3}");
	...
	protected IParser createRoleTypeConstraintsCardMinCardMax_4007Parser() {
		EAttribute[] features = new EAttribute[] {
				TMPackage.eINSTANCE.getRoleTypeConstraints_CardMin(),
				TMPackage.eINSTANCE.getRoleTypeConstraints_CardMax(), };
		MessageFormatParser parser = new MessageFormatParser(features);
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(TmceleditVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(TmceleditVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (TmceleditElementTypes.getElement(hint) == null) {
				return false;
			}
