 ...
 * @generated
 */
public class TmcleditElementTypes extends ElementInitializers {

	/**
	 * @generated
	 */
	private TmcleditElementTypes() {
	}
	...
	private static ImageDescriptor getProvidedImageDescriptor(
		...
		if (element instanceof EClass) {
			...
			if (!eClass.isAbstract()) {
				return TmcleditDiagramEditorPlugin.getInstance()
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(TopicMapSchema_79, ModelPackage.eINSTANCE
					.getTopicMapSchema());

			elements.put(NameType_1001, ModelPackage.eINSTANCE.getNameType());

			elements.put(ScopeType_1002, ModelPackage.eINSTANCE.getScopeType());

			elements.put(RoleType_1003, ModelPackage.eINSTANCE.getRoleType());

			elements.put(AssociationsType_1004, ModelPackage.eINSTANCE
					.getAssociationsType());

			elements.put(OccurenceType_1005, ModelPackage.eINSTANCE
					.getOccurenceType());

			elements.put(AssociationTypeConstraint_1006, ModelPackage.eINSTANCE
					.getAssociationTypeConstraint());

			elements.put(TopicType_1007, ModelPackage.eINSTANCE.getTopicType());

			elements.put(NameTypeConstraint_2001, ModelPackage.eINSTANCE
					.getNameTypeConstraint());

			elements.put(OccurenceTypeConstraint_2002, ModelPackage.eINSTANCE
					.getOccurenceTypeConstraint());

			elements.put(SubjectIdentifierConstraint_2003,
					ModelPackage.eINSTANCE.getsubjectIdentifierConstraint());

			elements.put(SubjectLocatorConstraint_2004, ModelPackage.eINSTANCE
					.getsubjectLocatorConstraint());

			elements.put(NameTypeConstraint_2005, ModelPackage.eINSTANCE
					.getNameTypeConstraint());

			elements.put(OccurenceTypeConstraint_2006, ModelPackage.eINSTANCE
					.getOccurenceTypeConstraint());

			elements.put(SubjectIdentifierConstraint_2007,
					ModelPackage.eINSTANCE.getsubjectIdentifierConstraint());

			elements.put(SubjectLocatorConstraint_2008, ModelPackage.eINSTANCE
					.getsubjectLocatorConstraint());

			elements.put(NameTypeConstraint_2009, ModelPackage.eINSTANCE
					.getNameTypeConstraint());

			elements.put(OccurenceTypeConstraint_2010, ModelPackage.eINSTANCE
					.getOccurenceTypeConstraint());

			elements.put(SubjectIdentifierConstraint_2011,
					ModelPackage.eINSTANCE.getsubjectIdentifierConstraint());

			elements.put(SubjectLocatorConstraint_2012, ModelPackage.eINSTANCE
					.getsubjectLocatorConstraint());

			elements.put(NameTypeConstraint_2013, ModelPackage.eINSTANCE
					.getNameTypeConstraint());

			elements.put(OccurenceTypeConstraint_2014, ModelPackage.eINSTANCE
					.getOccurenceTypeConstraint());

			elements.put(SubjectIdentifierConstraint_2015,
					ModelPackage.eINSTANCE.getsubjectIdentifierConstraint());

			elements.put(SubjectLocatorConstraint_2016, ModelPackage.eINSTANCE
					.getsubjectLocatorConstraint());

			elements.put(NameTypeConstraint_2017, ModelPackage.eINSTANCE
					.getNameTypeConstraint());

			elements.put(OccurenceTypeConstraint_2018, ModelPackage.eINSTANCE
					.getOccurenceTypeConstraint());

			elements.put(SubjectIdentifierConstraint_2019,
					ModelPackage.eINSTANCE.getsubjectIdentifierConstraint());

			elements.put(SubjectLocatorConstraint_2020, ModelPackage.eINSTANCE
					.getsubjectLocatorConstraint());

			elements.put(NameTypeConstraint_2021, ModelPackage.eINSTANCE
					.getNameTypeConstraint());

			elements.put(OccurenceTypeConstraint_2022, ModelPackage.eINSTANCE
					.getOccurenceTypeConstraint());

			elements.put(SubjectIdentifierConstraint_2023,
					ModelPackage.eINSTANCE.getsubjectIdentifierConstraint());

			elements.put(SubjectLocatorConstraint_2024, ModelPackage.eINSTANCE
					.getsubjectLocatorConstraint());

			elements.put(RoleTypeConstraints_3001, ModelPackage.eINSTANCE
					.getRoleTypeConstraints());

			elements.put(TopicTypeAko_3002, ModelPackage.eINSTANCE
					.getTopicType_Ako());

			elements.put(TopicTypeIsa_3003, ModelPackage.eINSTANCE
					.getTopicType_Isa());
		}
