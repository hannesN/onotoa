 ...
 * @generated
 */
public abstract class TmceleditAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = TmceleditDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected TmceleditAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
