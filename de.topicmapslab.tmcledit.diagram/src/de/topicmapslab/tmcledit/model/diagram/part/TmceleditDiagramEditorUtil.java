 ...
 * @generated
 */
public class TmceleditDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.TmceleditDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.TmceleditDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = TmceleditDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.TmceleditDiagramEditorUtil_CreateDiagramProgressTask,
				3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.TmceleditDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(de.topicmapslab.tmcledit.model.diagram.part.TmceleditDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(de.topicmapslab.tmcledit.model.diagram.part.TmceleditDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static TopicMapSchema createInitialModel() {
		return TMFactory.eINSTANCE.createTopicMapSchema();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(TopicMapSchema model,
			Resource resource) {
