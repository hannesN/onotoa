 ...
 * @generated
 */
public class TmcleditCreationWizard extends Wizard implements INewWizard {
	 ...
	 * @generated
	 */
	protected TmcleditCreationWizardPage diagramModelFilePage;
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle(Messages.TmcleditCreationWizardTitle);
		setDefaultPageImageDescriptor(TmcleditDiagramEditorPlugin
	...
	public boolean performFinish() {
				...
				if (isOpenNewlyCreatedDiagramEditor() && diagram != null) {
					try {
						...
						ErrorDialog.openError(getContainer().getShell(),
								Messages.TmcleditCreationWizardOpenEditorError,
								null, e.getStatus());
					}
				}
			}
		...
		try {
			...
			if (e.getTargetException() instanceof CoreException) {
				ErrorDialog.openError(getContainer().getShell(),
						Messages.TmcleditCreationWizardCreationError, null,
