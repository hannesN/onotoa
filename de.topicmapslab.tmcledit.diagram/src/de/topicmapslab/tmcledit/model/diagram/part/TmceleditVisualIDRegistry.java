 ...
 * @generated
 */
public class TmceleditVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return de.topicmapslab.tmcledit.model.diagram.part.TmceleditVisualIDRegistry
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (TMPackage.eINSTANCE.getTopicMapSchema().isSuperTypeOf(
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = de.topicmapslab.tmcledit.model.diagram.part.TmceleditVisualIDRegistry
		...
		if (TopicMapSchemaEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = de.topicmapslab.tmcledit.model.diagram.part.TmceleditVisualIDRegistry
		...
		case NameTypeEditPart.VISUAL_ID:
			if (TMPackage.eINSTANCE.getOccurenceTypeConstraint().isSuperTypeOf(
					domainElement.eClass())) {
				return OccurenceTypeConstraintEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getsubjectIdentifierConstraint()
					.isSuperTypeOf(domainElement.eClass())) {
				return SubjectIdentifierConstraintEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getsubjectLocatorConstraint()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case TopicTypeTopicTypeNameCompartmentEditPart.VISUAL_ID:
			if (TMPackage.eINSTANCE.getNameTypeConstraint().isSuperTypeOf(
					domainElement.eClass())) {
		...
		case TopicMapSchemaEditPart.VISUAL_ID:
			if (TMPackage.eINSTANCE.getNameType().isSuperTypeOf(
					domainElement.eClass())) {
				return NameTypeEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getScopeType().isSuperTypeOf(
					domainElement.eClass())) {
				return ScopeTypeEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getRoleType().isSuperTypeOf(
					domainElement.eClass())) {
				return RoleTypeEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getAssociationsType().isSuperTypeOf(
					domainElement.eClass())) {
				return AssociationsTypeEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getOccurenceType().isSuperTypeOf(
					domainElement.eClass())) {
				return OccurenceTypeEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getAssociationTypeConstraint()
					.isSuperTypeOf(domainElement.eClass())) {
				return AssociationTypeConstraintEditPart.VISUAL_ID;
			}
			if (TMPackage.eINSTANCE.getTopicType().isSuperTypeOf(
					domainElement.eClass())) {
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (TMPackage.eINSTANCE.getRoleTypeConstraints().isSuperTypeOf(
				domainElement.eClass())) {
