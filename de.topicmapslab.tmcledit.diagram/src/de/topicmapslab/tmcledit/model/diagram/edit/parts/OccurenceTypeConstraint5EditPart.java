...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.OccurenceTypeConstraint5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OccurenceTypeConstraint5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OccurenceTypeConstraint5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OccurenceTypeConstraint5ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.OccurenceTypeConstraint_2018,
