 ...
 * @generated
 */
public class TopicTypeAkoReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TopicTypeAkoReorientCommand(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getAko().remove(getOldTarget());
		getNewSource().getAko().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getAko().remove(getOldTarget());
		getOldSource().getAko().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
