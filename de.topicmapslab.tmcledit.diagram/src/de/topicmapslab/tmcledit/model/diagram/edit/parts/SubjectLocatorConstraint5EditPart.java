...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectLocatorConstraint5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectLocatorConstraint5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectLocatorConstraint5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectLocatorConstraint5ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectLocatorConstraint_2016,
