...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.OccurenceTypeConstraint6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OccurenceTypeConstraint6EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OccurenceTypeConstraint6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OccurenceTypeConstraint6ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.OccurenceTypeConstraint_2022,
