...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.NameTypeConstraint2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NameTypeConstraint2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NameTypeConstraint2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NameTypeConstraint2ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.NameTypeConstraint_2009,
