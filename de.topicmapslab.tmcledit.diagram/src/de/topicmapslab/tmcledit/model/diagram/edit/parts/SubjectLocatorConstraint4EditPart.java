...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectLocatorConstraint4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectLocatorConstraint4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectLocatorConstraint4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectLocatorConstraint4ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectLocatorConstraint_2012,
