...
public class ScopeTypeItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TmceleditElementTypes.OccurenceTypeConstraint_2006 == req
				.getElementType()) {
		...
		if (TmceleditElementTypes.SubjectIdentifierConstraint_2007 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(TMPackage.eINSTANCE
		...
		if (TmceleditElementTypes.SubjectLocatorConstraint_2008 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(TMPackage.eINSTANCE
