...
public class RoleTypeItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TmcleditElementTypes.OccurenceTypeConstraint_2010 == req
				.getElementType()) {
		...
		if (TmcleditElementTypes.SubjectIdentifierConstraint_2011 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ModelPackage.eINSTANCE
		...
		if (TmcleditElementTypes.SubjectLocatorConstraint_2012 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ModelPackage.eINSTANCE
