...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.OccurenceTypeConstraintItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OccurenceTypeConstraintEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OccurenceTypeConstraintEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OccurenceTypeConstraintItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.OccurenceTypeConstraint_2002,
