...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectIdentifierConstraint5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectIdentifierConstraint5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectIdentifierConstraint5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectIdentifierConstraint5ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectIdentifierConstraint_2019,
