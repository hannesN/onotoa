...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.OccurenceTypeConstraint2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OccurenceTypeConstraint2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OccurenceTypeConstraint2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OccurenceTypeConstraint2ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.OccurenceTypeConstraint_2006,
