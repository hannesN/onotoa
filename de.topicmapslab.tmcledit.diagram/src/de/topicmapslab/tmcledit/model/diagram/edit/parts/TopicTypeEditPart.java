 ...
 * @generated
 */
public class TopicTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public TopicTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TopicTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TopicTypeIdEditPart) {
			((TopicTypeIdEditPart) childEditPart).setLabel(getPrimaryShape()
