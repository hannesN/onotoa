...
public class OccurenceTypeItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TmcleditElementTypes.OccurenceTypeConstraint_2018 == req
				.getElementType()) {
		...
		if (TmcleditElementTypes.SubjectIdentifierConstraint_2019 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ModelPackage.eINSTANCE
		...
		if (TmcleditElementTypes.SubjectLocatorConstraint_2020 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ModelPackage.eINSTANCE
