 ...
 * @generated
 */
public class NameTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NameTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NameTypeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new NameTypeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NameTypeIdEditPart) {
			((NameTypeIdEditPart) childEditPart).setLabel(getPrimaryShape()
