...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.OccurenceTypeConstraint4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OccurenceTypeConstraint4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OccurenceTypeConstraint4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OccurenceTypeConstraint4ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.OccurenceTypeConstraint_2014,
