...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.NameTypeConstraintItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NameTypeConstraintEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NameTypeConstraintEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NameTypeConstraintItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.NameTypeConstraint_2001,
