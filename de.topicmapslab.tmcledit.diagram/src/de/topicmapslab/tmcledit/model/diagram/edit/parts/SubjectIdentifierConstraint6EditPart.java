...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectIdentifierConstraint6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectIdentifierConstraint6EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectIdentifierConstraint6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectIdentifierConstraint6ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectIdentifierConstraint_2023,
