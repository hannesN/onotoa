...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectLocatorConstraint6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectLocatorConstraint6EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectLocatorConstraint6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectLocatorConstraint6ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectLocatorConstraint_2020,
