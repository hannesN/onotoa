...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.NameTypeConstraint4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NameTypeConstraint4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NameTypeConstraint4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NameTypeConstraint4ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.NameTypeConstraint_2017,
