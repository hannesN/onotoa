...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectIdentifierConstraint4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectIdentifierConstraint4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectIdentifierConstraint4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectIdentifierConstraint4ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectIdentifierConstraint_2015,
