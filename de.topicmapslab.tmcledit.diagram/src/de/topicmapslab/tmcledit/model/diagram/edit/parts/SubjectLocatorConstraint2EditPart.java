...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectLocatorConstraint2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectLocatorConstraint2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectLocatorConstraint2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectLocatorConstraint2ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.NameTypeConstraint_2005,
