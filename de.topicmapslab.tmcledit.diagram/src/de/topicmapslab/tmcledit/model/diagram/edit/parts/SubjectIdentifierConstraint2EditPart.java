...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectIdentifierConstraint2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectIdentifierConstraint2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectIdentifierConstraint2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectIdentifierConstraint2ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectIdentifierConstraint_2007,
