...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectIdentifierConstraintItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectIdentifierConstraintEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectIdentifierConstraintEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectIdentifierConstraintItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectIdentifierConstraint_2003,
