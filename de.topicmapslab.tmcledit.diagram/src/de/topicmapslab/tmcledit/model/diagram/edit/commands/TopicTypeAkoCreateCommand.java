 ...
 * @generated
 */
public class TopicTypeAkoCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TopicTypeAkoCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof TopicType) {
			return false;
		}
		...
		return TmceleditBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateTopicTypeAko_3002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAko().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected TopicType getSource() {
		return (TopicType) source;
	}
