...
import de.topicmapslab.tmcledit.model.diagram.edit.policies.SubjectLocatorConstraint3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubjectLocatorConstraint3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SubjectLocatorConstraint3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectLocatorConstraint3ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TmceleditParserProvider.HintAdapter(
					TmceleditElementTypes.SubjectLocatorConstraint_2008,
