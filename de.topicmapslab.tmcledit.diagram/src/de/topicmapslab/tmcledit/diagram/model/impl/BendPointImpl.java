...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bend Point</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.topicmapslab.tmcledit.diagram.model.impl.BendPointImpl#getPosX <em>Pos X</em>}</li>
 *   <li>{@link de.topicmapslab.tmcledit.diagram.model.impl.BendPointImpl#getPosY <em>Pos Y</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BendPointImpl extends EObjectImpl implements BendPoint {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.BEND_POINT;
	}
	...
	public void setPosX(int newPosX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BEND_POINT__POS_X, oldPosX, posX));
	}
	...
	public void setPosY(int newPosY) {
		...
		posY = newPosY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BEND_POINT__POS_Y, oldPosY, posY));
	}
