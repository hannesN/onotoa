...
public class TMCLTemplateDefinitions {
	...
	/**
	 * Constructor
	 * @param writer the ctmwriter used to serialize the topic map
	 * @param topicMap the topicmap to serialize
	 */
	...
	/**
	 * The list of templates used for serializing the topic map
	 * 
	 * @return
	 */
...
//		addBelongsTo();
	...
	/*
	 * def has-item-identifier($tt, $min, $max, $regexp) ?c isa
	 * tmcl:item-identifier-constraint; tmcl:card-min: $min; tmcl:card-max:
	 * $max; tmcl:regexp: $regexp. tmcl:constrained-topic-type(tmcl:constraint :
	 * ?c, tmcl:constrained : $tt) end
	 */
	...
	private void addMustHaveReifier() {
		...
		OccurrenceEntry o1 = entryFactory.newOccurrenceEntry(entryFactory.newValueParam("1"),
		        entryFactory.newTopicTypeParam(cardMin));
		t1.add(o1);

		OccurrenceEntry o2 = entryFactory.newOccurrenceEntry(entryFactory.newValueParam("1"),
		        entryFactory.newTopicTypeParam(cardMax));
		t1.add(o2);
	...
	private void addCannotHaveReifier() {
		...
		OccurrenceEntry o1 = entryFactory.newOccurrenceEntry(entryFactory.newValueParam("0"),
		        entryFactory.newTopicTypeParam(cardMin));
		t1.add(o1);

		OccurrenceEntry o2 = entryFactory.newOccurrenceEntry(entryFactory.newValueParam("0"),
		        entryFactory.newTopicTypeParam(cardMax));
		t1.add(o2);
	...
	private void addHasDatatype() {
		...
		OccurrenceEntry o1 = entryFactory.newOccurrenceEntry(entryFactory.newVariableParam("dt"),
		        entryFactory.newTopicTypeParam(datatype));
		t1.add(o1);
	...
	/*
	 * # Abstract Constraint def is-abstract($tt) ?c isa
	 * tmcl:abstract-constraint. tmcl:constrained-topic-type(tmcl:constraint :
	 * ?c, tmcl:constrained : $tt) end
	 */
	...
	private void addMatchesRegExp() {
		...
		OccurrenceEntry o1 = entryFactory.newOccurrenceEntry(entryFactory.newVariableParam("regexp"),
		        entryFactory.newTopicTypeParam(regExp));
		t1.add(o1);
