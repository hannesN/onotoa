...
/**
 * This is the item provider adapter for a {@link de.topicmapslab.tmcledit.model.BendPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BendPointItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BendPoint_posX_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BendPoint_posX_feature", "_UI_BendPoint_type"),
				 ModelPackage.Literals.BEND_POINT__POS_X,
				 true,
				 false,
				 false,
	...
	protected void addPosYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BendPoint_posY_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BendPoint_posY_feature", "_UI_BendPoint_type"),
				 ModelPackage.Literals.BEND_POINT__POS_Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_BendPoint_type") + " " + bendPoint.getPosX();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BendPoint.class)) {
			case ModelPackage.BEND_POINT__POS_X:
			case ModelPackage.BEND_POINT__POS_Y:
