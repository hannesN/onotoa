...
/**
 * This is the item provider adapter for a {@link de.topicmapslab.tmcledit.model.AbstractContraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractContraintItemProvider
	 ...
	 * @generated
	 */
	public AbstractContraintItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractContraint)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractContraint_type") :
			getString("_UI_AbstractContraint_type") + " " + label;
	}
