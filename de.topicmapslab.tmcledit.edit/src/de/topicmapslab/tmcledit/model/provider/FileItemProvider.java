...
/**
 * This is the item provider adapter for a {@link de.topicmapslab.tmcledit.model.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.FILE__FILENAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.FILE__DIAGRAMS);
			childrenFeatures.add(ModelPackage.Literals.FILE__TOPIC_MAP_SCHEMA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.FILE__DIAGRAMS,
				 ModelFactory.eINSTANCE.createDiagram()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.FILE__TOPIC_MAP_SCHEMA,
				 ModelFactory.eINSTANCE.createTopicMapSchema()));
	}
