...
/**
 * This is the item provider adapter for a {@link de.topicmapslab.tmcledit.model.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.COMMENT__CONTENT,
				 true,
				 false,
				 false,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_width_feature", "_UI_Comment_type"),
				 ModelPackage.Literals.COMMENT__WIDTH,
				 true,
				 false,
				 false,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_height_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_height_feature", "_UI_Comment_type"),
				 ModelPackage.Literals.COMMENT__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Comment_type") + " " + comment.getPosX();
	}
