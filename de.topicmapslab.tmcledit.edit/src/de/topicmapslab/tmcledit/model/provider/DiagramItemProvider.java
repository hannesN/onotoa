...
/**
 * This is the item provider adapter for a {@link de.topicmapslab.tmcledit.model.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diagram_nodes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diagram_nodes_feature", "_UI_Diagram_type"),
	...
	protected void addEdgesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diagram_edges_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diagram_edges_feature", "_UI_Diagram_type"),
				 ModelPackage.Literals.DIAGRAM__EDGES,
				 true,
				 false,
				 true,
				 null,
