...
/**
 * This is the item provider adapter for a {@link de.topicmapslab.tmcledit.model.AbstractCardinalityContraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractCardinalityContraintItemProvider
	 ...
	 * @generated
	 */
	public AbstractCardinalityContraintItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractCardinalityContraint)object).getSee_also();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractCardinalityContraint_type") :
			getString("_UI_AbstractCardinalityContraint_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractCardinalityContraint.class)) {
