 ...
 * <!-- end-user-doc -->
 * @see de.topicmapslab.tmcledit.model.TMPackage
 * @generated
 */
public class TMSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TMPackage.NAME_TYPE_CONSTRAINT: {
			...
			case TMPackage.ASSOCIATIONS_TYPE: {
			...
			case TMPackage.ROLE_TYPE_CONSTRAINTS: {
			...
			case TMPackage.SUBJECT_IDENTIFIER_CONSTRAINT: {
			...
			case TMPackage.ASSOCIATION_TYPE_CONSTRAINT: {
			...
			case TMPackage.MAPPING_ELEMENT: {
