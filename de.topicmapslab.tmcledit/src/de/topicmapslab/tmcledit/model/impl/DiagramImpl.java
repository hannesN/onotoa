...
public class DiagramImpl extends EObjectImpl implements Diagram {
	 ...
	 * @generated
	 */
	public EList<Edges> getEdges() {
		if (edges == null) {
			edges = new EObjectContainmentEList<Edges>(Edges.class, this, ModelPackage.DIAGRAM__EDGES);
		}
		return edges;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.DIAGRAM__EDGES:
				getEdges().clear();
				getEdges().addAll((Collection<? extends Edges>)newValue);
				return;
		}
