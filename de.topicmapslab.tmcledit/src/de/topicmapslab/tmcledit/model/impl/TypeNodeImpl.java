 ...
 * <ul>
 *   <li>{@link de.topicmapslab.tmcledit.model.impl.TypeNodeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeNodeImpl extends NodeImpl implements TypeNode {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.TYPE_NODE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TopicType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TYPE_NODE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.TYPE_NODE__TYPE:
