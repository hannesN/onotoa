...
public class TMPackageImpl extends EPackageImpl implements TMPackage {
	 ...
	 * @see de.topicmapslab.tmcledit.model.TMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static TMPackage init() {
		...
		TMPackageImpl theTMPackage = (TMPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof TMPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new TMPackageImpl());
