 ...
 * <ul>
 *   <li>{@link de.topicmapslab.tmcledit.model.impl.OccurrenceTypeConstraintImpl#getType <em>Type</em>}</li>
 ...
 * @generated
 */
public class OccurrenceTypeConstraintImpl extends AbstractConstraintImpl implements OccurrenceTypeConstraint {
	/**
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.OCCURRENCE_TYPE_CONSTRAINT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TopicType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OCCURRENCE_TYPE_CONSTRAINT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.OCCURRENCE_TYPE_CONSTRAINT__TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractTypedConstraint.class) {
			switch (derivedFeatureID) {
				case ModelPackage.OCCURRENCE_TYPE_CONSTRAINT__TYPE: return ModelPackage.ABSTRACT_TYPED_CONSTRAINT__TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractTypedConstraint.class) {
			switch (baseFeatureID) {
				case ModelPackage.ABSTRACT_TYPED_CONSTRAINT__TYPE: return ModelPackage.OCCURRENCE_TYPE_CONSTRAINT__TYPE;
				default: return -1;
			}
		}
		if (baseClass == AbstractTypedCardinalityConstraint.class) {
