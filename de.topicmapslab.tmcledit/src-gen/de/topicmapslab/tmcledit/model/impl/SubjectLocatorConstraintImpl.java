...
public class SubjectLocatorConstraintImpl extends AbstractRegExpConstraintImpl implements SubjectLocatorConstraint {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractCardinalityContraint.class) {
			switch (derivedFeatureID) {
				case ModelPackage.SUBJECT_LOCATOR_CONSTRAINT__CARD_MIN: return ModelPackage.ABSTRACT_CARDINALITY_CONTRAINT__CARD_MIN;
				case ModelPackage.SUBJECT_LOCATOR_CONSTRAINT__CARD_MAX: return ModelPackage.ABSTRACT_CARDINALITY_CONTRAINT__CARD_MAX;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractCardinalityContraint.class) {
			switch (baseFeatureID) {
				case ModelPackage.ABSTRACT_CARDINALITY_CONTRAINT__CARD_MIN: return ModelPackage.SUBJECT_LOCATOR_CONSTRAINT__CARD_MIN;
				case ModelPackage.ABSTRACT_CARDINALITY_CONTRAINT__CARD_MAX: return ModelPackage.SUBJECT_LOCATOR_CONSTRAINT__CARD_MAX;
				default: return -1;
			}
		}
    ...
    public boolean equals(Object obj) {
	    ...
	    if (getClass() != obj.getClass())
		    return false;
	    SubjectLocatorConstraintImpl other = (SubjectLocatorConstraintImpl) obj;
	    if (cardMax == null) {
